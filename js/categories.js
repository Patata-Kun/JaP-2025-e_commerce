...
let currentProductSortCriteria = undefined;
...
// NUEVA FUNCIÓN DE ORDENAMIENTO DE PRODUCTOS
function sortProducts(criteria, array) {
    let result = [...array]; // Crear copia para no mutar el original
...
// NUEVA FUNCIÓN PARA ORDENAR Y MOSTRAR PRODUCTOS
function sortAndShowProducts(sortCriteria) {
    currentProductSortCriteria = sortCriteria;
    currentProductsArray = sortProducts(currentProductSortCriteria, currentProductsArray);
    showProducts(currentProductsArray);
}

// NUEVA FUNCIÓN PARA ACTUALIZAR BOTÓN ACTIVO
...
// NUEVA FUNCIÓN PARA CONFIGURAR EVENT LISTENERS DE PRODUCTOS
...
document.addEventListener('DOMContentLoaded', function(e) {
    // Cargar categorías (código existente)
...
// FETCH DE CARGA DE LOS PRODUCTOS ACTUALIZADO
